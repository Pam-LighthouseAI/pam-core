...
# \xc3\xa2\xe2\x80\xa0\xe2\x80\x99 should be → (\xe2\x86\x92)
...
# \xc3\xa2\xe2\x80\xa0 should be ← (\xe2\x86\x90) or just remove
...
# 2. Corrupted em dash
# \xc3\xa2\xe2\x82\xac\xe2\x80\x9d should be — (\xe2\x80\x94)
...
# 3. Corrupted quotes
# \xc3\xa2\xe2\x80\x9c should be " (\xe2\x80\x9c)
...
# \xc3\xa2\xe2\x80\x9d should be " (\xe2\x80\x9d)
...
# \xc3\xa2\xe2\x80\x99 should be ' (\xe2\x80\x99)
...
# \xc3\xa2\xe2\x80\xa6 should be … (\xe2\x80\xa6)
...
print(f"\nRemaining \\xc3\\x83: {verify.count(b'\\xc3\\x83')}")
print(f"Remaining \\xc3\\xa2\\xe2\\x80: {verify.count(b'\\xc3\\xa2\\xe2\\x80')}")
print(f"Remaining \\xc3\\xa2\\xe2\\x82: {verify.count(b'\\xc3\\xa2\\xe2\\x82')}")